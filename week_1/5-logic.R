...
# Hint: if you would like to programmatically clear your environment, use "rm(list = ls() )"
# CAUTION: You cannot reverse this in R
...
# Remember for help use: ?isTRUE or help("isTRUE")
...
# For help on the which() use > ?which or help("which)
...
# You should know what to do for help by now.... :) 
...
# what you can do with logic, check out the Control Flow lesson given in Week 3 Lesson 2."
